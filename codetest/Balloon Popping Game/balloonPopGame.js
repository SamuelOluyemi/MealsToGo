...
// $('<audio src="Balloon Popping Game/audio/soundclick.wav" id="mySound"></audio>').appendTo('a');
...
function noBalloons() {
    if (balloon0.style.background === "none" && balloon1.style.background === "none"
    && balloon2.style.background === "none" && balloon3.style.background === "none"
    && balloon4.style.background === "none" && balloon5.style.background === "none"
    && balloon6.style.background === "none" && balloon7.style.background === "none"
    && balloon8.style.background === "none" && balloon9.style.background === "none"
    && balloon10.style.background === "none" && balloon11.style.background === "none"
    && balloon12.style.background === "none" && balloon13.style.background === "none"
    && balloon14.style.background === "none" && balloon15.style.background === "none"
    && balloon16.style.background === "none" && balloon17.style.background === "none"
    && balloon18.style.background === "none" && balloon19.style.background === "none"
    && balloon20.style.background === "none" && balloon21.style.background === "none"
    && balloon22.style.background === "none" && balloon23.style.background === "none"
    ) {
